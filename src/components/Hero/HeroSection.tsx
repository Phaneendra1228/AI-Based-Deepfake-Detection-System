...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section id="hero" className="relative pt-8 pb-16 md:pt-14 md:pb-24 overflow-hidden bg-white">
      ...
      <div className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-blue-100/40 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-indigo-100/35 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 border border-blue-200/80 text-xs font-mono text-blue-700 mb-6 shadow-xs backdrop-blur-md">
              ...
              <span className="text-slate-500 font-normal">DEFENSE GRADE</span>
            </div>

            {/* Main Heading */}
            <h1 className="font-display font-bold text-4xl sm:text-6xl xl:text-7xl tracking-tight text-slate-900 leading-[1.08] mb-6">
              See Beyond <br />
              <span className="relative inline-block">
                ...
                <span className="absolute -bottom-2 left-0 right-0 h-1.5 bg-gradient-to-r from-blue-500 via-indigo-500 to-transparent rounded-full opacity-80" />
              </span>
            </h1>
            ...
            <p className="text-base sm:text-lg text-slate-600 max-w-2xl leading-relaxed mb-8 font-normal">
              ...
              <strong className="text-slate-900 font-semibold"> DeepGuard AI</strong> unpacks facial micro-movements, 
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 w-full sm:w-auto mb-8">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-semibold text-sm bg-white border border-slate-200 text-slate-700 hover:text-blue-600 hover:border-blue-300 hover:bg-slate-50 shadow-xs transition-all duration-200"
              >
            ...
            {/* Feature Trust Strip */}
            <div className="pt-6 border-t border-slate-200/80 w-full flex flex-wrap items-center gap-y-2.5 gap-x-6 text-xs font-mono text-slate-500">
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-blue-600" />
                <span className="text-slate-700">Image & Video Forensics</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-indigo-600" />
                <span className="text-slate-700">ResNet-50 Feature Extraction</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-600" />
                <span className="text-slate-700">Canvas Error Level Analysis</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 relative flex flex-col items-center">
            ...
            <div className="w-full flex flex-col sm:flex-row items-center justify-between gap-2 mb-3">
              ...
              <div className="flex items-center gap-1 p-1 rounded-xl bg-slate-100 border border-slate-200 shadow-xs overflow-x-auto no-scrollbar w-full sm:w-auto">
              ...
              {/* View Mode Switcher */}
              <div className="flex items-center gap-1 p-1 rounded-xl bg-slate-100 border border-slate-200 shadow-xs shrink-0">
                <button
                  onClick={() => {
                    sounds.playBlip();
                    setVisualMode('photo');
            ...
            <div className="relative w-full">
              {visualMode === 'photo' ? (
                <div
                  className={`relative w-full aspect-square max-w-[480px] mx-auto rounded-2xl bg-white border-2 ${
                    isManipulatedState
      ...
      <div className="hidden md:flex justify-center mt-12">
        <a
          ...
          className="p-2.5 rounded-full border border-slate-200 bg-white shadow-xs hover:border-blue-300 text-slate-400 hover:text-blue-600 transition-colors"
        >
