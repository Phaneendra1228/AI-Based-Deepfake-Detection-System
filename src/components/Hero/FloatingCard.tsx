...
export const FloatingCard: React.FC<FloatingCardProps> = ({ isManipulated, onToggle }) => {
  ...
  return (
    <div
      className={`bg-white/95 rounded-2xl p-5 border transition-all duration-500 shadow-xl backdrop-blur-xl ${
        isManipulated
    ...
    >
      ...
      <div className="flex items-center justify-between border-b border-slate-100 pb-3">
        ...
        <div className="flex items-center gap-2">
          <span className="px-2 py-0.5 rounded-md text-[10px] font-mono font-semibold bg-slate-100 border border-slate-200/80 text-slate-700">
            VERIFIED COMPLETE
          </span>
          <button
      ...
      <div className="flex items-center justify-between gap-4 my-4">
        <div>
          <div className="text-[11px] font-mono font-semibold text-slate-400 mb-1">CLASSIFICATION RESULT</div>
            ...
            <div>
              <div
                className={`font-display font-extrabold text-lg leading-tight tracking-tight ${
                  isManipulated ? 'text-rose-600' : 'text-emerald-700'
                }`}
              >
        ...
        <div className="relative w-16 h-16 shrink-0 flex items-center justify-center">
          <svg className="w-full h-full transform -rotate-90" viewBox="0 0 64 64">
            ...
            <circle
              ...
              cy="32"
              r="26"
              stroke={isManipulated ? '#E11D48' : '#2563EB'}
              strokeWidth="4"
          ...
          <div className="absolute flex flex-col items-center justify-center text-center">
            ...
            <span className="text-[8px] font-mono font-medium text-slate-500 leading-tight">CONF</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2 pt-2 border-t border-slate-100 text-center">
        <div className="p-2 rounded-xl bg-slate-50 border border-slate-200/70">
          <div className="text-[10px] font-mono text-slate-500 mb-0.5">Visual Cohesion</div>
          <div
            className={`text-xs font-bold font-mono ${
              isManipulated ? 'text-rose-600' : 'text-blue-600'
            }`}
          >
        ...
        <div className="p-2 rounded-xl bg-slate-50 border border-slate-200/70">
          <div className="text-[10px] font-mono text-slate-500 mb-0.5">Facial Geometry</div>
          <div
            className={`text-xs font-bold font-mono ${
              isManipulated ? 'text-rose-600' : 'text-blue-600'
            }`}
        ...
        <div className="p-2 rounded-xl bg-slate-50 border border-slate-200/70">
          <div className="text-[10px] font-mono text-slate-500 mb-0.5">Pixel ELA</div>
          <div
            className={`text-xs font-bold font-mono ${
              isManipulated ? 'text-rose-600' : 'text-blue-600'
            }`}
